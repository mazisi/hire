...
<script src="https://unpkg.com/filepond@^4/dist/filepond.js"></script>
    ...
    <div class="col-xl-12">
        <div class="dashboard-box margin-top-0">
            ...
            <i>@if(pathinfo($attachment->file_path, PATHINFO_EXTENSION) == 'pdf')
                PDF
                @elseif(pathinfo($attachment->file_path, PATHINFO_EXTENSION) == 'doc' || pathinfo($attachment->file_path, PATHINFO_EXTENSION)=='docx' )
                DOCX
            @endif</i>
            <button type="button" x-data onclick="return confirm('Are you sure?') ? @this.delete_document('{{ $attachment->id }}') : false"
                 class="remove-attachment" data-tippy-placement="top" data-tippy="" data-original-title="Remove"></button>
        </div>
        @endforeach
...
FilePond.create($refs.input);">
    ...
    <div class="col-xl-12">
        <button type="submit" class="button ripple-effect big margin-top-30"><i class="icon-feather-check"></i> Save</button>
    </div>
</form>
